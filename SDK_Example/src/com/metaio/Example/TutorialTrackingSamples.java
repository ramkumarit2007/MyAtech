...
public class TutorialTrackingSamples extends ARViewActivity 
{
	...
	{
		trackingConfigFile = AssetsManager.getAssetPath("TutorialTrackingSamples/Assets/TrackingData_Marker.xml");
	...
	{
		trackingConfigFile = AssetsManager.getAssetPath("TutorialTrackingSamples/Assets/TrackingData_PictureMarker.xml");
		MetaioDebug.log("Tracking Config path = "+trackingConfigFile);
	...
	{
		trackingConfigFile = AssetsManager.getAssetPath("TutorialTrackingSamples/Assets/TrackingData_MarkerlessFast.xml");
		MetaioDebug.log("Tracking Config path = "+trackingConfigFile);
	...
	protected void loadContents() 
	{
		try
		{
			...
			String metaioManModel = AssetsManager.getAssetPath("TutorialTrackingSamples/Assets/metaioman.md2");			
