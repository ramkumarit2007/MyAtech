...
public class TutorialContentTypes extends ARViewActivity 
{
	...
	protected void loadContents() 
	{
		try
		{
			...
			final String trackingConfigFile = AssetsManager.getAssetPath("TutorialContentTypes/Assets/TrackingData_MarkerlessFast.xml");
			
			final boolean result = metaioSDK.setTrackingConfiguration(trackingConfigFile); 
			MetaioDebug.log("Tracking data loaded: " + result); 
	        
			// Load all the geometries. First - Model
			final String modelPath = AssetsManager.getAssetPath("TutorialContentTypes/Assets/metaioman.md2");			
			if (modelPath != null) 
			{
			...
			final String imagePath = AssetsManager.getAssetPath("TutorialContentTypes/Assets/frame.png");
			if (imagePath != null)
			{
			...
			final String moviePath = AssetsManager.getAssetPath("TutorialContentTypes/Assets/demo_movie.3g2");
			if (moviePath != null)
			{
			...
			final String truckPath = AssetsManager.getAssetPath("TutorialContentTypes/Assets/truck/truck.obj");
			if (truckPath != null)
			{
			...
			final String path = AssetsManager.getAssetPath("TutorialContentTypes/Assets/env_map.zip");
			if (path != null)
			{
