...
public class TutorialHelloWorld extends ARViewActivity 
{
	...
	protected void loadContents() 
	{
		try
		{
			...
			String trackingConfigFile = AssetsManager.getAssetPath("TutorialHelloWorld/Assets/TrackingData_MarkerlessFast.xml");
			...
			String metaioManModel = AssetsManager.getAssetPath("TutorialHelloWorld/Assets/metaioman.md2");			
