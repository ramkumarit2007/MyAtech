...
public class TutorialDynamicLighting extends ARViewActivity
{
	...
	{
		final String modelPath = AssetsManager.getAssetPath("TutorialDynamicLighting/Assets/sphere_10mm.obj");
		if (modelPath != null)
		{
	...
	protected void loadContents()
	{
		try
		{
			final String trackingConfigFile = AssetsManager.getAssetPath("TutorialDynamicLighting/Assets/TrackingData_MarkerlessFast.xml");
			...
			final String modelPath = AssetsManager.getAssetPath("TutorialDynamicLighting/Assets/cube_50mm.obj");
			if (modelPath != null)
			{
