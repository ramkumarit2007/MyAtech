...
public class TutorialCustomShading extends ARViewActivity
{
	...
	protected void loadContents()
	{
		try
		{
			final String trackingConfigFile = AssetsManager.getAssetPath("TutorialCustomShading/Assets/TrackingData_MarkerlessFast.xml");
			...
			final String modelPath = AssetsManager.getAssetPath("TutorialCustomShading/Assets/metaioman.md2");
			if (modelPath != null)
			{
			...
			final String shaderMaterialsFile = AssetsManager.getAssetPath("TutorialCustomShading/Assets/shader_materials.xml");
