...
public class TutorialDynamicModels extends ARViewActivity 
{
	...
	protected void loadContents() 
	{
		try
		{
			System.out.println("INside loadContent");
			
			// TODO: Load desired tracking data for planar marker tracking
			String filepath = AssetsManager.getAssetPath("TutorialDynamicModels/Assets/dummy.xml");
			
			boolean result = metaioSDK.setTrackingConfiguration(filepath); 
			MetaioDebug.log("Tracking data loaded: " + result); 
	       System.out.println("result:"+result); 
			// Load all the geometries
			filepath = AssetsManager.getAssetPath("TutorialDynamicModels/Assets/metaioman.md2");			
			if (filepath != null) 
			{
