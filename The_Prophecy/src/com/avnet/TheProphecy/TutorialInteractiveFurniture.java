...
public class TutorialInteractiveFurniture extends ARViewActivity 
{
	...
	protected void loadContents() 
	{
		try 
		{
			...
			String filepath = AssetsManager.getAssetPath("TutorialInteractiveFurniture/Assets/tv.obj");
			if (filepath != null) 
			{
			...
			// Load screen
			filepath = AssetsManager.getAssetPath("TutorialInteractiveFurniture/Assets/screen.obj");
			if (filepath != null) 
			{
				...
				if (mScreen != null) 
				{
					...
					mScreen.setMovieTexture(AssetsManager.getAssetPath("TutorialInteractiveFurniture/Assets/sintel.3g2"));
					mScreen.startMovieTexture(true);
			...
			// Load chair
			filepath = AssetsManager.getAssetPath("TutorialInteractiveFurniture/Assets/stuhl.obj");
			if (filepath != null) 
			{
			...
			// Load metaio man
			filepath = AssetsManager.getAssetPath("TutorialInteractiveFurniture/Assets/metaioman.md2");
			if (filepath != null) 
			{
