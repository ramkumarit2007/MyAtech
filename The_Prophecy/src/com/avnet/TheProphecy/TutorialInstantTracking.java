...
public class TutorialInstantTracking extends ARViewActivity 
{
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		try
		{
			...
			FileInputStream fis = new FileInputStream(AssetsManager.getAssetPath("TutorialInstantTracking/Assets/meow.mp3"));
	...
	protected void loadContents() 
	{
		...
		{
			// Load tiger model
			String tigerModelPath = AssetsManager.getAssetPath("TutorialInstantTracking/Assets/tiger.md2");			
